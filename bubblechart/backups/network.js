  ...
  function run(graph) {
    ...
    function fade(opacity) {
      return d => {
        ...
        link.style('stroke', o => ((o.source === d || o.target === d) && o.value>0 ? "black" : o.value > 0 ? "#d3d3d3":""));
      ...
      node
         ...
         .on('mouseover.tooltip', function(d) {
          ...
          .on("mouseout",function(){
            d3version4.select(this).style("fill","#efefef");
            link.style('stroke', "")//function(d) { return d.value > 0 ? "#d3d3d3" : ""});
